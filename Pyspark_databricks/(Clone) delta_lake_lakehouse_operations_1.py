...
# MAGIC %sql
# MAGIC SELECT count(1) FROM drugstbl_merge TIMESTAMP AS OF '2026-02-02T17:51:35.000+00:00';
...
# MAGIC --INSERT INTO acid_demo_txn VALUES (5, -100);--Atomicity and consistancy #violated
